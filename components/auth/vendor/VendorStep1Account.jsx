...
export default function VendorStep1Account({ formData, updateField, onNext }) {
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <p className={styles.subtitle}>Start with your name, email, and a password. We&apos;ll collect your business details next.</p>
