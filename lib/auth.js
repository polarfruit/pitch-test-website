...
export async function sendPresignupCode(email) {
  const endpoint = '/api/presignup/send-code'
  try {
    const response = await fetch(endpoint, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export async function verifyPresignupCode(email, code) {
  const endpoint = '/api/presignup/verify-code'
  try {
    const response = await fetch(endpoint, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export async function signupVendor(payload) {
  const endpoint = '/api/signup/vendor'
  try {
    const response = await fetch(endpoint, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export async function signupOrganiser(payload) {
  const endpoint = '/api/signup/organiser'
  try {
    const response = await fetch(endpoint, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
export async function resendEmailCode() {
  const endpoint = '/api/verify/email/resend'
  try {
    const response = await fetch(endpoint, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
